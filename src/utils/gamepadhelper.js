    ...
    Object.values(this.gamepads).forEach((gamepad) => {
      ...
      for (let i = 0; i < gamepad.buttons.length; i++) {
        if (this.gamepadsLastUpdate) {
          let buttonLastUpdate =
            this.gamepadsLastUpdate[gamepad.index].buttons[i];
          ...
          if (button.value == 1 && buttonLastUpdate.value == 0) {
            // ONLY FOR DEV PURPOSES. DISCOMMENT TO ENABLE LOGS
            // console.log(
            //   "gamepad " +
            //     gamepad.index +
            //     ": button " +
            ...
            // ONLY FOR DEV PURPOSES. DISCOMMENT TO ENABLE LOGS
            // console.log(
            //   "gamepad " + gamepad.index + ": button " + buttonLabel + " is up"
            // );
